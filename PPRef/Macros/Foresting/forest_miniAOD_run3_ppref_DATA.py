...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        '/store/data/Run2024J/PPRefHardProbes0/MINIAOD/PromptReco-v1/000/387/396/00000/15e37f96-bfbc-44bc-a050-c77e74f72f19.root'
    )
)
...
for jetLabel in jetLabels:
    ...
    getattr(process,"ak"+jetLabel+"PFJetAnalyzer").doIterativeDeclustering = cms.untracked.bool(True)
    getattr(process,"ak"+jetLabel+"PFJetAnalyzer").zcut = cms.double(0.2)
    getattr(process,"ak"+jetLabel+"PFJetAnalyzer").beta = cms.double(0.0)
    getattr(process,"ak"+jetLabel+"PFJetAnalyzer").useRawPt = cms.untracked.bool(True)
